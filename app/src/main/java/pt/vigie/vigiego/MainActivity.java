...
import pt.vigie.controller.BackgroundTagProcessor;
import pt.vigie.controller.BackgroundUploadService;
import pt.vigie.controller.DBAdapter;
import pt.vigie.controller.WebServiceRequest;
import pt.vigie.controller.UploadReceiver;
import pt.vigie.model.IntentOption;
import pt.vigie.model.LoginSession;
...
import pt.vigie.view.AboutFragment;
import pt.vigie.view.Chart;
import pt.vigie.view.Claim;
import pt.vigie.view.Home;
import pt.vigie.view.Login;
import pt.vigie.view.Logout;
import pt.vigie.view.NavigationDrawerFragment;
import pt.vigie.view.NoContent;
import pt.vigie.view.ProfilePage;
import pt.vigie.view.Profiles;
import pt.vigie.view.ReadTag;
import pt.vigie.view.StartFragment;
import pt.vigie.view.StopFragment;
import pt.vigie.view.TagInfoFragment;
...
*/
      ...
      // ((TextView)findViewById(R.id.action_bar_title)).setTypeface(font);
        ...
        if(DBAdapter.getInstance().hasLogin()){
            LoginSession.getInstance().setUsername(DBAdapter.getInstance().getUserEmail());
            LoginSession.getInstance().setPassword(DBAdapter.getInstance().getUserPassword());
